...
use super::types::{CachedTokenization, QueryCacheStats, QueryKey};
use crate::fingerprint::Fingerprint;
use std::collections::HashMap;
use std::sync::atomic::{AtomicUsize, Ordering};
use tokio::sync::RwLock;

/// In-memory query cache storing memoized tokenizations and fingerprints.
#[derive(Debug)]
...
impl QueryMemoCache {
    ...
    pub async fn stats(&self) -> QueryCacheStats {
        ...
        QueryCacheStats {
            ...
            entries: tokens_len + fingerprints_len,
        }
    }
}
