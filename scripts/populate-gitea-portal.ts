...
const MILESTONES = [
  {
    title: "v0.1.0 - Initial Core Engine & Fast Mod M61 Rolling Hash",
    description: "Milestone v0.1.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v0.1.1 - Type-2 Normalization & React WebUI",
    description: "Milestone v0.1.1",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v0.1.2 - Tree-sitter AST & cddm-mcp Server",
    description: "Milestone v0.1.2",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v0.2.0 - CI/CD Integration & AI Agent Tooling",
    description: "Milestone v0.2.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v0.3.0 - Caching, Differential Scans & Refactoring",
    description: "Milestone v0.3.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v0.4.0 - WebUI Studio & Visual Analytics",
    description: "Milestone v0.4.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v0.5.0 - AST Merkle Pipeline & Polyglot Expansion",
    description: "Milestone v0.5.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.0.0 - High-Throughput Enterprise Engine",
    description: "Milestone v1.0.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.1.0 - N-Way Clone Graph Clustering & Deduplication",
    description: "Milestone v1.1.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.2.0 - Language Server Protocol & IDE Extensions",
    description: "Milestone v1.2.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.3.0 - Historical Trends & Turnkey CI/CD Workflows",
    description: "Milestone v1.3.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.4.0 - Intelligent AST Suppression & Refactor Sandbox",
    description: "Milestone v1.4.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.5.0 - Polyglot Expansion & AI Prompt Synthesizer",
    description: "Milestone v1.5.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.6.0 - AST-Native Rewrite Engine & Test Verification",
    description: "Milestone v1.6.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.7.0 - Architectural Boundary Policies & 22 Grammars",
    description: "Milestone v1.7.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.8.0 - AI Code Surgeon & Self-Healing Refactor",
    description: "Milestone v1.8.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v1.9.0 - Deep Semantic Graph Matching & Monorepo Cache",
    description: "Milestone v1.9.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.0.0 - Ecosystem Packaging & Distribution",
    description: "Milestone v2.0.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.1.0 - First-Class IDE Ecosystem & VSIX Pipeline",
    description: "Milestone v2.1.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.3.0 - Cross-Language Semantic Matching & Embeddings",
    description: "Milestone v2.3.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.4.0 - Automated Shared Module & Crate Extraction",
    description: "Milestone v2.4.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.5.0 - Interactive Terminal UI Studio & Parity Gate",
    description: "Milestone v2.5.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.6.0 - Polyglot AST Rewriters & Shared Extraction",
    description: "Milestone v2.6.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.7.0 - Automated Polyglot Unit Test Synthesizer",
    description: "Milestone v2.7.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.8.0 - Automated Micro-Benchmark Synthesizer",
    description: "Milestone v2.8.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v2.9.0 - Context-Aware Program Slicing for AI Surgeon",
    description: "Milestone v2.9.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v3.0.0 - Ecosystem Library Reimplementation & Overlap",
    description: "Milestone v3.0.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v3.1.0 - Automated GitHub PR Fix-Bot Action",
    description: "Milestone v3.1.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v3.2.0 - High-Performance Parser Recycling & AST Memo",
    description: "Milestone v3.2.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "closed" as const,
  },
  {
    title: "v3.3.0 - Dead Clone Elimination & Graph Reachability",
    description: "Milestone v3.3.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "open" as const,
  },
  {
    title: "v3.4.0 - Semantic Neural Vector Embeddings & 3D UI",
    description: "Milestone v3.4.0",
    due_on: "2026-12-31T23:59:59Z",
    state: "open" as const,
  },
  {
